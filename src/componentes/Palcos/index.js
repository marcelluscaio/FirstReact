   ...
   return(
      props.colaboradores.length > 0 && <section className='palco' style={{backgroundColor: props.cor2}}>
         ...
         <div className='palco__colaboradores'>
            {props.colaboradores.map(colaborador => <Colaborador key={colaborador.nome} nome={colaborador.nome} cargo={colaborador.cargo} imagem={colaborador.imagem} palco={colaborador.palco} cor={props.cor1} />)}
         </div>
      </section>
   )
}
